	...
	function fn_initProc(){
		...
		$.ajax({
			...
			success : function(res) {
				...
				//TODO : 결제관련 임시 주석처리 - ksi_edit.240702
...
<div class="contents-wrap">
    <section class="indivi-area" style="background-color: #365486; border-radius: 0 0 15px 15px; padding-top: 2rem; padding-bottom: 1rem;">
        <ul>
            <li>
    ...
    <section style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; padding: 0px 5.5%; place-items: stretch; margin-top: 16px; margin-bottom: 10px;">
	...
	<!-- <section class="common-area">
		<a href="/app/customer/my_noti">
			<div class="swiper" style="box-sizing: border-box; border-radius: 15px; width: 100%; margin-top: 10px; padding: 20px 20px; background-color: #fff; box-shadow: 0 0 6px #0000000D;">
				 -->
