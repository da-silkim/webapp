...
<div class="contents-wrap">
    ...
    <section style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; padding: 0px 5.3%; place-items: stretch; margin-bottom: 5%; background-color: #365486; border-radius: 0 0 15px 15px; padding-bottom: 1rem;">
